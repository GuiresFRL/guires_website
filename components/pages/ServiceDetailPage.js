    ...
    if (!service) {
        return (
            <section className="pt-40 pb-24 text-center max-w-xl mx-auto px-6">
                ...
                <a href="https://guiresfrl.github.io/guires_website/services.html" className="inline-flex items-center gap-2 rounded-full bg-[var(--accent)] text-white text-sm font-semibold px-6 py-3">
