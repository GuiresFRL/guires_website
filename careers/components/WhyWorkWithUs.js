            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
                    {WHY_WORK_CARDS.map((card) => (
                        ...
                        >
                            <div className="absolute top-3 right-4 text-5xl font-extrabold text-[var(--cw-border)] select-none transition-colors duration-300 group-hover:text-[#0C4DA21A]">{card.num}</div>
                            <div
                            ...
                            <h3 className="relative text-lg font-bold text-[var(--cw-text)] mb-2">{card.title}</h3>
